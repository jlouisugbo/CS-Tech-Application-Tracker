...
const statusConfig = {
  ...
  waitlisted: { color: 'bg-amber-100 text-amber-800', icon: Clock, label: 'Waitlisted' },
  offer: { color: 'bg-emerald-100 text-emerald-800', icon: TrendingUp, label: 'Offer Received' },
  offer_accepted: { color: 'bg-green-200 text-green-900', icon: CheckCircle, label: 'Offer Accepted' },
  offer_rejected: { color: 'bg-red-200 text-red-900', icon: XCircle, label: 'Offer Rejected' },
